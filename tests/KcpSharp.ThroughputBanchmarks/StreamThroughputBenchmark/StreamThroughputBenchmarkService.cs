...
{
    internal sealed class StreamThroughputBenchmarkService : IUdpService, IKcpTransport, IDisposable
    {
        ...
        public StreamThroughputBenchmarkService(IUdpServiceDispatcher sender, EndPoint endPoint, KcpConversationOptions options)
        {
            _sender = sender;
            _endPoint = endPoint;
